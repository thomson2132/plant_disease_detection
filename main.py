...
DEST_DIR = "C:/Users/thoms/OneDrive/Desktop/Capstone/Split_PlantVillage"
...
LEARNING_RATE = 5e-5
PATIENCE = 3
MODEL_SAVE_PATH = "efficientnet_b0_best.pth"
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# ==== STEP 1: AUTO-SPLIT FUNCTION ====
def auto_split_dataset(source_dir, dest_dir, ratios):
    ...
    for class_name in os.listdir(source_dir):
        ...
        if not os.path.isdir(class_path):
            continue
        if class_name.lower() in ['train', 'val', 'test', 'plantvillage']:
            continue
...
if __name__ == "__main__":
    ...
    # Step 3: Load Training Data for Sampling
    ...
    # Step 4: Build Model (EfficientNetB0 + Dropout)
